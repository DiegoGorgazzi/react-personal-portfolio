...
<div className={aboutMeStyles.aboutMe}>
  ...
  <p> I started this journey trying to solve a specific problem.  Because of these new skills,
    I now believe that problem is insignificant compared to
     the other problems I now envision I can help solve. </p>
  ...
  <p> Soon thereafter I found WordPress. It was flexible,
    customizable, full of functionality, and simple to use.
  ...
  <p> To solve the specific problem I had, I thought I needed to learn
  Python, which I did a few years ago. </p>

  <p>This is where I realized
  that learning a certain coding language is like learning
...
<p> However, starting with my first day of work, I discovered not only that I didn't know
  anything right out of school,
  but I learned something new every single day of my career (and my humility
